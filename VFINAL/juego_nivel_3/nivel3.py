...
def juego_nivel_3(pantalla, reloj):

    proyect_dir = os.path.dirname(os.path.dirname(__file__))
    ruta_musica = os.path.join(proyect_dir, "assets", "nivel_3", "Music3.mp3")
...
#-------------------------------------------------------------------------.
    ...
    obstaculos = [
        ...
        Pincho(         700,  suelo_y - 20, ancho=40, alto=20),
        Pincho(         800,  suelo_y - 20, ancho=40, alto=20),
        Cuadrado(       1200,  suelo_y - 40, ancho=40, alto=40)
    ]
    gadgets = [
    ...
    while jugando:
       ...
       # calculo de scroll
        ...
        if jugador.pos[0] >= nivel_ancho - jugador.ancho:
