...
def juego_nivel_2(pantalla, reloj):

    proyect_dir = os.path.dirname(os.path.dirname(__file__))
    ruta_musica = os.path.join(proyect_dir, "assets", "nivel_2", "Music2.mp3")
...
#-------------------------------------------------------------------------.
    ...
    portales = [
    Portal(687, 525, 5, 95, color=(0, 255, 0), tipo="nave")   # verde: convierte a nave
